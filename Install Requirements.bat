...
python310\App\Python\python -m pip install --upgrade transformers tokenizers safetensors langdetect langid huggingface_hub hf_xet --no-warn-script-location
